...
<body>
  ...
  <form action = attendance2.php method = "post" style ="text-align: center;" autocomplete="off">
    ...
    <table border="1" align="center">
      ...
      <tr style = "text-align: center;">
        <td><input type = "text" name = "username" size = "16" value = "CNuser" style = "text-align: center;"></td>
        <td><input type = "password" name = "password" size = "16" value = "CNpassword" style = "text-align: center;"></td>
      </tr>
    </table>  
